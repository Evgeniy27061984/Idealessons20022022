...
import thebyteguru12.graphics.Sprite;
import thebyteguru12.graphics.SpriteSheet;
...
public class Player extends Entity {
    ...
    public Player( float x, float y, float scale,float speed, TexturesAtlas atlas) { // public пока мы не создали доп класс
