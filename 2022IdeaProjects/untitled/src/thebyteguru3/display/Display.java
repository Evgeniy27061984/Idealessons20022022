...
public abstract class Display {
    ...
    public static void render() { //all that we want add in our window
        ...
        bufferGraphics.fillOval((int)(350 + (Math.sin(delta) * 200)),400,100,100); //второй круг
        ((Graphics2D)(bufferGraphics)).setRenderingHint(RenderingHints.KEY_ANTIALIASING,
                RenderingHints.VALUE_ANTIALIAS_OFF); // delete сглаживани чтобы первый круг без сглаживания
        delta += 0.02f;
