package thebyteguru3.main;

import thebyteguru3.display.Display;
...
public class Main {
    public static void main(String[] args) {
        Display.create(800,600,"Tanks",0xff00ff00,3); //clearColor цве т которым будем очищать наш экран
